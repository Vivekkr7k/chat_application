      ...
      <div className="flex-1 p-6">
        <div className="flex items-center mb-4 flex-col">
          <button
            ...
            className="bg-[#5443c3] rounded-2xl hover:bg-blue-700 text-white font-bold py-1 px-2  h-10 mb-4 mr-2"
          >
        ...
        {isModalOpen && ( 
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            <div className="bg-[#f7f7ff] shadow-md rounded px-8 pt-6 pb-8 w-full max-w-lg mx-2 sm:mx-4 md:mx-6 lg:mx-auto xl:mx-auto">
              <h2 className="text-2xl font-bold mb-4 text-[#5443c3] ">Register <br></br><span className="text-lg font-light mb-4 underline text-[#5443c3] my-10">Please fill with your details</span></h2>
              ...
              <form onSubmit={handleSubmit} className="w-full">
                ...
                <div className="mb-4">
                  <label className="block text-[#5443c3] text-sm font-bold mb-2" htmlFor="teamName">
                    Team Name
                  </label>
                  <select
                    className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
